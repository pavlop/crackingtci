...
public class DigitsAsListsStraight {
    ...
    private static class NodeAndSumFromPreviosu {
        ...
        private NodeAndSumFromPreviosu(SingleNode node, int sumFromPreviousStep) {
            this.node = node;
    ...
    public static SingleNode<Integer> sumStraightDigits (MySinglyLinkedList<Integer> lisst1, MySinglyLinkedList<Integer> lisst2) {
        ...
        if (result.sumFromPreviousStep != 0) {
            SingleNode<Integer> leadingNode = new SingleNode<Integer>(result.sumFromPreviousStep,result.node);
            return leadingNode;
        } else {
            return result.node;
        }
    ...
    private static NodeAndSumFromPreviosu  findSumRecursive(int fromPreviousSumm, SingleNode<Integer> node1, SingleNode<Integer> node2) {
        ...
        SingleNode<Integer> newNode = new SingleNode<Integer>(newValue);
